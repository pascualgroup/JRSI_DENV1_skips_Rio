...
# ---- paramnames ----
paramnames = c("mu_H", "gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
               "sigma_M", "I_0", "R_0", "C_0", "r", "g", "epsilon")
...
# ---- par_trans ----
par_trans = parameter_trans(log = c("mu_H", "gamma", "sigma_P", "sigma_M", "r", "epsilon"),
                            logit = c("rho"))
...
# ---- paramnames_spark ----
paramnames_spark = c("mu_H", "gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
               "sigma_M", "I_0", "R_0", "C_0", "r", "g", "epsilon", "spark", "spark_time")
...
# ---- paramnames_spark ----
paramnames_spark_month = c("mu_H", "gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
                     "sigma_M", "I_0", "R_0", "C_0", "r", "g", "epsilon", "spark", "spark_time_start",
                     "spark_time_end")

# ---- paramnames_spark_month_stop_immigration ----
paramnames_spark_month_stop_immigration = c("mu_H", "gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
                           "sigma_M", "I_0", "R_0", "C_0", "r", "g", "epsilon", "spark", "spark_time_start",
