...
# ---- paramnames ----
paramnames = c("mu_H", "mu_EI","gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
               "sigma_M", "E_0", "I_0", "R_0", "C_0", "r", "g", "epsilon")
...
rproc <- Csnippet("
                  ...
                  double beta = exp(b_1*s_1 + b_2*s_2 + b_3*s_3 + g);
...
rproc <- Csnippet("
                  ...
                  if(isnan(R) || isnan(I) || isnan(E) || isnan(N) || isnan(S)){
...
dmeas <- Csnippet("
                  ...
                  double total_0 = round(I_0) + round(E_0) + round(R_0);
                 ...
                 R = round(N_0);
                    ...
                    if(R_0 < 0 || I_0 < 0 || E_0 < 0 || N_0 < 0){
                      ...
                      S = 1;
                        ...
                        N = round(N_0);
                        R = round(R_0);
                        S = round(N_0)-round(I_0)-round(E_0) - round(R_0);
                    }
                 }
...
# ---- par_trans ----
par_trans = parameter_trans(log = c("mu_H", "mu_EI", "gamma", "sigma_P", "sigma_M", "r", "epsilon"),
                            logit = c("rho"))
...
# ---- statenames_spark ----
statenames_spark = c("S", "E","I", "R" , "C", "N", "spark_activated")


# ---- paramnames_spark ----
paramnames_spark = c("mu_H", "mu_EI","gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
               "sigma_M", "E_0", "I_0", "R_0", "C_0", "r", "g", "epsilon", "spark", "spark_time")
...
statenames_spark_month = c("S", "E","I", "R" , "C", "N")

# ---- paramnames_spark ----
paramnames_spark_month = c("mu_H", "mu_EI","gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
                     "sigma_M", "E_0", "I_0", "R_0", "C_0", "r", "g", "epsilon", "spark", "spark_time_start",
                     "spark_time_end")

# ---- paramnames_spark_month_stop_immigration ----
paramnames_spark_month_stop_immigration = c("mu_H", "mu_EI","gamma", "N_0", "rho", "b_1", "b_2","b_3", "sigma_P", 
                           "sigma_M", "E_0", "I_0", "R_0", "C_0", "r", "g", "epsilon", "spark", "spark_time_start",
