...
plot_profiles = function(Sup_Fig_df, Sup_Fig_prof_peak_treshold_df,
  ...
  p = ggplot() +
    ...
    geom_hline(data =Sup_Fig_prof_peak_treshold_df, aes(yintercept = Profile_threshold,
    ...
    geom_vline(data = Sup_Fig_prof_peak_value_for_prof_var_df,
    ...
    p = p + scale_color_manual(name="Color Legend",values=c( "purple", "pink"),
                               breaks = c( "5", "6"), labels = c("2 LL from MLE and Profile Peak",
                                                                                   "MLE and Profile Peak Value")) +
      scale_linetype_manual(name="Line Type Legend",values=c(1), labels = c("Both"))
  }else{
  ...
  p = ggplot() +
    ...
    geom_vline(data = Sup_Fig_MLE_value_for_prof_var_df,
               aes(xintercept = MLE_value_for_prof_var,
                   ...
                   linetype = Line_Type_Group), size = 1.0, show.legend= F) +
    ylim(y_thres, NA) 
  p = p + scale_color_manual(name="Color Legend",values=c("red", "darkgreen"),
