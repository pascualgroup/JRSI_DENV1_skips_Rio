...
Fig_4_combined = Fig_4_combined + rahul_big_panel_theme +
  ...
  guides(fill=FALSE, alpha = FALSE) +theme(axis.text.y = element_text(size = 14))
Fig_4_combined
...
tiff(
  ...
  height = 10, width = 10, res = 500, units = "in")# print(grid.arrange(Sup_Fig_3_A_comb, Sup_Fig_3_B_comb, legend,Sup_Fig_3_C_comb, Sup_Fig_3_D_comb,
#                    ncol = 3, widths = c(1,1,0.9)))
Fig_4_combined
dev.off()
```
