...
Fig_3_D_plot_data = relevant_skip_plot_data_delta_07
Fig_3_D = ggplot(data = relevant_skip_plot_data_delta_07,
             aes(x = r0, y = skips)) +
...
Fig_3_D
Fig_3_D_plot_data$plot_var = ""
test = ggplot(data = Fig_3_D_plot_data,
             aes(x = r0, y = skips)) +
  geom_point(color = 'red', size = 3,
...
Fig_3_D_plot_data$Line_Color = "No_Line"

#Fig_3_D_plot_data = rbind(Fig_3_D_plot_data, rho_3_line_df)
...
### Joining Figure 3 Panels ABC with Panel D

```{r}
Fig_3_ABC_plot_data
head(Fig_3_ABC_plot_data)
head(Fig_3_D_plot_data)
...
Fig_3_D_plot_data_subset = Fig_3_D_plot_data %>%
  dplyr::select(var_value =  'R[0]', LL = skips)
Fig_3_D_plot_data_subset$Profile_Var = 'R[0]'
Fig_3_D_plot_data_subset$plot_var_label = ' R[0]'
Fig_3_D_plot_data_subset$Metric = "Skips"
Fig_3_D_plot_data_subset$low_bound = -1
Fig_3_combined_data = join(Fig_3_ABC_plot_data, Fig_3_D_plot_data_subset, type = 'full')
Fig_3_combined_data$plot_var_label = factor(Fig_3_combined_data$plot_var_label, levels = c("beta[0]", "rho",     "delta",   " R[0]"))
rho_3_line_df = rho_3_line_df %>%
  dplyr::select(var_value =  'R[0]', LL = skips) %>%
...
tiff(
  paste0(
    "../Figures/Manuscript_Figures/TIFF_Files/Fig5.tiff"),
  height = 5, width = 10, res = 300, units = "in")
print(p)
dev.off()
```
