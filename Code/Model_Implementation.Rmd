...
Fig_3_ABC = ggplot(data = Fig_3_ABC_plot_data)  + geom_point(aes(x = var_value, y = LL)) +
  ylim(y_lim_min, NA) +
  rahul_man_figure_theme + rahul_big_panel_theme + rahul_panel_theme +theme_white_background  +
...
Fig_3_D_plot_data_subset$low_bound = 0
...
Fig_3_comb_plot = ggplot(data = Fig_3_combined_data)  + geom_point(aes(x = var_value, y = LL, color = Metric, shape = Metric)) +
  rahul_man_figure_theme + rahul_big_panel_theme  +theme_white_background  +
    geom_hline(aes(yintercept = ML -2), size = 1.0, linetype = "dashed", color = 'grey70') +
  geom_hline(aes(yintercept = low_bound), color = 'white') +
  geom_vline(aes(xintercept = MLE_value_for_prof_var),
