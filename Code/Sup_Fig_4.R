...
Fig_S4_comb_plot = ggplot()  + geom_point(data = Sup_Fig_4_combined_data, aes(x = var_value, y = LL, color = Metric, shape = Metric)) +
  ...
  geom_hline(data = Sup_Fig_4_combined_data, aes(yintercept = ML -2), size = 1.0, linetype = "dashed", color = 'grey70') +
...
Sup_Fig_4_comb = Sup_Fig_4 + rahul_panel_theme + theme(legend.position = "None")




pdf("../Figures/Supplemental_Figures/Supplemental_Figure_4/Supplemental_Figure_4_Combined.pdf")
# print(grid.arrange(Sup_Fig_4_A_comb, Sup_Fig_4_B_comb, legend,Sup_Fig_4_comb, Sup_Fig_4_D_comb,
#                    ncol = 3, widths = c(1,1,0.9)))
 print(Sup_Fig_4_comb)
dev.off()
